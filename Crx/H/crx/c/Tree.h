...
/* NOTES:
	...
	- DERIVED ALGORITHMS:
		- THIS IS A BTREE PRIMARILY. IT HAS 8 OPTIONS LEADING TO 144 VARIATIONS
		- OPTION INDEX:
		...
		- OPTION WHEN INDEX USED, INDEX IN LEAVES, NO INDEX IN LEAVES: 
			...
			- DESIGN, HISTORY
				...
				- BECAUSE OF THE REQUIREMENT OF THE "EDGE" FEATURE OF 
						...
						"EDGE" FEATURE WOULD HAVE TO BE DISABLED IF AN OPTION IS ADDED TO DECIDE ON 
						AN APPROACH AND THE OPTION THAT IS CHOSEN IS THE APPROACH TO COMPARE THE 
						ELEMENTS THEMSELVES INSTEAD. THIS IS WHY, TREE ONLY EXPECTS WEAK TYPE2 
						INDICES, MEANING STRONG INDICES ARE NOT REQUIRED.
		- OPTION PRESISTANCE
		...
		- OPTIONS DELEGATION OR NO DELEGATION.
			...
			- ORIGINALLY DELEGATION WAS USED FOR ALL TREES. DURING THE VERIFICATION WORK OF
					...
					ALL THE TREES. SEE THE HISTORY BELOW.
			...
			- HISTORY
					...
					NOTE THAT WHEN THE PRIMARY ENTRIES ARE IN THE LEAVES ONLY, AND THE ALGORITHM
						...
						SITUATION IS CORRECTED, MEANING BEFORE THE NODE IS MERGED WITH ANOTHER. IF
						...
						FOUND ELEMENT FROM THE LEAF, A COPY OF THE FIRST ELEMENT IN THE LEAF,
						OR AN INDEX, IS TO BE HOISTED UP, AND HENCE THERE HAS TO BE ONE ELEMENT
						REMAINING. THIS IS UNLIKE THE CASE WHERE THE PRIMARY ENTRIES ARE STORED
						...
						NECESSARY WHEN ELEMENTS ARE INSERTED. HOWEVER, DURING REMOVAL A 'DELEGATE' 
						IS NOT REMOVED SIMPLY BECAUSE THAT WHICH IT IS A DELEGATE FOR HAS BEEN 
						REMOVED. THIS MAKES IT NOT TRULY A DELEGATE. HOWEVER NOTE THE FOLLOWING,
	...
	3				pIndexOfNodeInParent IS SMALLER THAN THE MAXIMUM NUMBER OF CHILDREN. SAME 
		...
		- Tree::removeElement()
			- IF THIS FUNCTION FAILS, THIS FUNCTION FAILS BECAUSE THE ELEMENT TO BE REMOVED WAS
	...
	- TEMPLATE:
		- OVERRIDES:
			...
			5- CRX__C__Tree__DECLARE(pTREE_TYPE_NAME, pMEMBER_FUNCTIONS_PREFIX,
					...
					pIS_ELEMENT_DATA_IN_LEAVES_ONLY, pIS_DELEGATION_MANDATORY_WHEN_POSSIBLE,
					pIS_PERSISTANCE_MANDATORY, pIS_CONSERVATIVE_IN_GROWTH, pIS_PREEMPTIVE, pIS_TO_USE_RINGS,
		...
		- MEANING:
			...
			- OVERRIDES 3 AND 4 DECLARE TREES THAT DO NOT USE AN INDEX, AND THEIR PRIMARY ENTRIES 
					ARE IN THE LEAVES ONLY. USE OVERRIDE '3' IF THE ELEMENT IS NON COPYABLE. USE 
					'4', IF THE TYPE OF ELEMENT IS COPYABLE OR RAW COPYABLE.
...
#define _CRX__C__Tree__DECLARE(pTREE_TYPE_NAME, pMEMBER_FUNCTIONS_PREFIX, \
	...
	PRIVATE bool pMEMBER_FUNCTIONS_PREFIX ## private_transferAndInsertElementEntry__do( \
			...
			pELEMENT_TYPE * CRX_NOT_NULL pElement))); \
	\
	PUBLIC size_t pMEMBER_FUNCTIONS_PREFIX ## getSize(pTREE_TYPE_NAME const * pThis); \
	\
	...
	PRIVATE void pMEMBER_FUNCTIONS_PREFIX ## iterator_private_remove__do( \
			...
			pELEMENT_TYPE * * pElement__out)))); \
	\
	PUBLIC pELEMENT_TYPE * pMEMBER_FUNCTIONS_PREFIX ## iterator_unsafeGet( \
			pTREE_TYPE_NAME ## _Iterator const * pThis); \
	PUBLIC pELEMENT_TYPE const * pMEMBER_FUNCTIONS_PREFIX ## iterator_get( \
			pTREE_TYPE_NAME ## _Iterator const * pThis); \
...
\
	...
	\
											...
											pFUNC_ELEMENT_DESTRUCTOR( \
													pMEMBER_FUNCTIONS_PREFIX ## iterator_unsafeGet( \
													&tIterator));, ) \
	\
											CRXM__IFELSE2(pIS_PERSISTANT, \
											free(pMEMBER_FUNCTIONS_PREFIX ## iterator_unsafeGet( \
													&tIterator));, ) \
	\
	...
	{ \
		...
		bool tIsToSwap = false; \
	\
		if(pCOMPARE_ELEMENTS(pMEMBER_FUNCTIONS_PREFIX ## iterator_unsafeGet(pIterator), \
				vElement) == 0) \
			{tIsFound = true;} \
	\
		if(!tIsFound) \
...
#define CRX__C__TREE__FLAG__NULL 									0
#define CRX__C__TREE__FLAG__INDICES_IN_INTERNAL_NODES_ONLY 			1
#define CRX__C__TREE__FLAG__ELEMENT_DATA_IN_LEAVES_ONLY				2
#define CRX__C__TREE__FLAG__DELEGATION_IS_MANDATORY					4
#define CRX__C__TREE__FLAG__DELEGATION_IS_MANDATORY_WHEN_POSSIBLE \
		CRX__C__TREE__FLAG__DELEGATION_IS_MANDATORY
#define CRX__C__TREE__FLAG__PERSISTANCE_IS_MANDATORY				8
...
/*WITHOUT INDEX, PRIMARY ENTRIES EVERYWHERE
	...
	THESE CORRESPOND TO THE TEMPLATE OVERRIDES 1 AND 2. SEE NOTES ABOVE.
*/
...
/*WITHOUT INDEX, PRIMARY ENTRIES IN LEAVES ONLY. ELEMENT MUST BE COPYABLE
	...
	THESE CORRESPOND TO THE TEMPLATE OVERRIDE 4. SEE NOTES ABOVE.
*/
...
/*WITHOUT INDEX, PRIMARY ENTRIES IN LEAVES ONLY. ELEMENT MUST BE NON COPYABLE
	...
	THESE CORRESPOND TO THE TEMPLATE OVERRIDE 3. SEE NOTES ABOVE.
*/
...
/*WITH INDEX
	...
	ALLOWED FLAGS
			...
			CRX__C__TREE__FLAG__DELEGATION_IS_MANDATORY_WHEN_POSSIBLE
			CRX__C__TREE__FLAG__PERSISTANCE_IS_MANDATORY
			CRX__C__TREE__FLAG__CONSERVATIVE_IN_GROWTH
			CRX__C__TREE__FLAG__PREEMPTIVE
			CRX__C__TREE__FLAG__USES_RINGS
			
	THESE CORRESPOND TO THE TEMPLATE OVERRIDES 5, 6. SEE NOTES ABOVE.
*/
