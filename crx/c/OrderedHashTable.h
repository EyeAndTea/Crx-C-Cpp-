...
#define _CRX__C__OrderedHashTable__DECLARE(pHASH_TABLE_TYPE_NAME, pMEMBER_FUNCTIONS_PREFIX, \
		...
		PUBLIC, PRIVATE) \
	\
	typedef struct pHASH_TABLE_TYPE_NAME ## _Private_KeyNode pHASH_TABLE_TYPE_NAME ## _Private_KeyNode; \
	\
...
CRX__LIB__PUBLIC_C_FUNCTION() void crx_c_orderedHashTable_copyGet(Crx_C_OrderedHashTable const * pThis, \
